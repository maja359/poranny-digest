...
import snapshot       # zrzut gotowej tresci przed renderem (siatka na oplacony, wywalony run)
import render_digest  # render + publikacja; wspoldzielone z resume_digest.py
...
# ---------------------------------------------------------------- snapshot + render
# Tresc jest gotowa i OPLACONA. Zrzucamy ja na dysk ZANIM wejdziemy w render,
# bo to render potrafi sie wywalic na jednym polu w zlym ksztalcie (14-15.08.2026),
# a wtedy bez snapshotu przepada caly koszt runu. Workflow wrzuca ten plik jako
# artefakt, gdy run padnie; `resume_digest.py` sklada z niego wydanie za darmo.
ctx = {
    "c": c,
    "inn_tag": inn_tag,
    "date_pl": date_pl,
